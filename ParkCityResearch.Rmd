...
ParkCitySnowTotals2019 = stack(ParkCity2019[2:ncol(ParkCity2019)])
...
```{r}
# make snowtotals into one column
ParkCitySnowTotals2020 = stack(ParkCity2020[2:ncol(ParkCity2020)])
...
trn = sample(seq_len(nrow(totalDaily)), 580)
