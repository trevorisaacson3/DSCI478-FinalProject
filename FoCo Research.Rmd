...
```{r}
factorAnalysis(westCaliBreck)
factorAnalysis(westCaliFoCo)
factorAnalysis(capeBreck)
factorAnalysis(capeFoCo)
factorAnalysis(tillamookBreck)
# factorAnalysis(tillamookFoCo)
```
