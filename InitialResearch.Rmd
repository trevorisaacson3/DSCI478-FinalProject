...
DailyData2020["Snowfall"] = ParkCity2020$Snowfall
DailyData2020["Snowfall14DaysLater"] = ParkCity2020$Snowfall14DaysLater
...
```{r}
ggplot(data = DailyData2020, aes(x = Day, y = WaveHeight)) +
  geom_line() +
  facet_wrap(~Month)
...
```{r}
totalDaily = rbind(DailyData2019, DailyData2020)
totalDaily <- totalDaily %>%
  select(-c("Year", "Month", "Day"))

totalDaily
predictedSnow = lm(Snowfall14DaysLater ~ . , data = totalDaily)
