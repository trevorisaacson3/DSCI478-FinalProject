...
AverageDailyData2019["Snowfall13DaysLater"] = ParkCity2019$Snowfall13DaysLater
AverageDailyData2019["Snowfall14DaysLater"] = ParkCity2019$Snowfall14DaysLater
AverageDailyData2019["Snowfall15DaysLater"] = ParkCity2019$Snowfall15DaysLater
AverageDailyData2019["AvgSnowfall3DayWindow"] = (ParkCity2019$Snowfall13DaysLater + ParkCity2019$Snowfall14DaysLater + ParkCity2019$Snowfall15DaysLater) /3 
...
AverageDailyData2020["Snowfall13DaysLater"] = ParkCity2020$Snowfall13DaysLater
AverageDailyData2020["Snowfall14DaysLater"] = ParkCity2020$Snowfall14DaysLater
AverageDailyData2020["Snowfall15DaysLater"] = ParkCity2020$Snowfall15DaysLater
AverageDailyData2020["AvgSnowfall3DayWindow"] = (ParkCity2020$Snowfall13DaysLater + ParkCity2020$Snowfall14DaysLater + ParkCity2020$Snowfall15DaysLater) /3 
...
totalDaily
predictedSnow = lm(AvgSnowfall3DayWindow ~ ., data = totalDaily)
...
Trees with All Data
```{r}
initial_tree = tree(AvgSnowfall3DayWindow ~ ., data = totalDaily)
...
```{r}
bag_fit <- randomForest(AvgSnowfall3DayWindow ~ ., data = totalDaily, mtry = ncol(totalDaily) - 1, importance = TRUE)
plot(bag_fit)
